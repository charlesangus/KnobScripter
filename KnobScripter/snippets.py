...
class SnippetsWidget(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        self.scroll_layout.setContentsMargins(QtCore.QMargins(0, 0, 0, 0))
        self.scroll.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.scroll.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.scroll_content.setContentsMargins(QtCore.QMargins(0, 0, 8, 0))
        self.scroll.setWidgetResizable(True)
        self.scroll.setSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
